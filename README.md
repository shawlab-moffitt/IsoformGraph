...
The current app uses `PTPRC` as the default example gene and includes a transcript support level filter. The Shiny interface contains a gene-symbol input, transcript-support cutoff, a generate button, a combined exon/splice-graph plot, and an exon-node table. :contentReference[oaicite:0]{index=0}
...
- Filter transcripts using APPRIS transcript support level
